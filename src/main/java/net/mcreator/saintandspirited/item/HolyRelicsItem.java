...
public class HolyRelicsItem extends SaintAndSpiritedModElements.ModElement {
	@ObjectHolder("saint_and_spirited:holy_relics")
	public static final Item block = null;
	public HolyRelicsItem(SaintAndSpiritedModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Someone is leading you"));
		}
