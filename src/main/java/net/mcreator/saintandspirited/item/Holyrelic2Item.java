...
public class Holyrelic2Item extends SaintAndSpiritedModElements.ModElement {
	@ObjectHolder("saint_and_spirited:holyrelic_2")
	public static final Item block = null;
	public Holyrelic2Item(SaintAndSpiritedModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SaintandSpiritedItemGroup.tab).maxDamage(1).rarity(Rarity.EPIC));
			setRegistryName("holyrelic_2");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("You are filled with respect"));
		}
