...
public class BoardItem extends SaintAndSpiritedModElements.ModElement {
	@ObjectHolder("saint_and_spirited:board")
	public static final Item block = null;
	public BoardItem(SaintAndSpiritedModElements instance) {
		super(instance, 13);
	}
